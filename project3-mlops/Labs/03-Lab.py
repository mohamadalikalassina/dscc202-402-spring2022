...
def mlflow_rf(data_path, bootstrap, min_impurity_distance):
    ...
    rf = RandomForestRegressor(datapath,bootstrap,min_impurity_decrease)
    ...
    # Log params
    mlflow.log_param("datapath", datapath)
